...
export function RabbleLoader() {
  return (
    <div className="w-full h-screen grid place-items-center">
      <RabbleIcon className="animate-pulse h-10 w-10 text-slate-600" />
    </div>
  );
}

type RabbleIconProps = ComponentProps<"svg">;

export function RabbleIcon({ className, ...props }: RabbleIconProps) {
  return (
    <svg
      role="img"
